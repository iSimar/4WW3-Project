var listFormat = false;var ptBaseURI = getptBaseURI();var const_keyCode = { ARRLEFT : 37,ARRUP : 38,ARRRIGHT : 39,ARRDN : 40,ENTER : 13,
 ...
 else if (key == 90 && !ptUtil.isAltKey(ev)) {
 ...
 var szMenuCrefNav = bcUpdater.getStoredData(bcUpdater.isMenuCrefNav); var szHistory = sessionStorage["pt_history"]; var szHistoryLastNui = sessionStorage["pt_history_last_nui"];   sessionStorage.clear(); sessionStorage.setItem(this.tKey,ct);    if (typeof szMenuCrefNav != "undefined" && szMenuCrefNav) {
