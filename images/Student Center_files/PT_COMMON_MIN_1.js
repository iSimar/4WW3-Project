...
PT_Dialog.prototype = {
 ...
 if (modObj.bAutoClose && (modObj.sTitle == '')) {
 modObj.bHeader = true; modObj.sTitle = "&nbsp;";  }
 },
...
setModalDialogBack: function (id, sBackIdQS, sBackTitle, bBackCancel) {
 ...
 modObj.sBackIdQS = sBackIdQS; modObj.sBackTitle = sBackTitle; modObj.sBackTitle = bBackCancel; oheader.children[0].innerHTML = "<span class='ps-button-wrapper' title='" + modObj.sBackTitle + "'><a class='ps-button' role='button' href=\"javascript:backMenu('" + sBackIdQS + "')\" onclick=\"javascript:backMenu('" + sBackIdQS + "')\"><img src='" + modalBackUrl + "' alt='" + modalBackAlt + "'></a></span>"
 }
